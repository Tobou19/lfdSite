...
const Resources = () => {
  ...
  //     description:
  //       "Mélange 100% naturel – spiruline, moringa, gingembre et curcuma.",
  //     price: 8500,
  //     image:
  //       "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8NsS0nlgjgOUMCHXF1VuerX09oE9fKvCCXg&s",
  //   },
  //   {
  //     id: 2,
  //     name: "Thé Minceur Métabolique",
  //     description:
  //       "Accélère la combustion, régule l'appétit & réduit la rétention d’eau.",
  //     price: 6500,
  //     image:
  //       "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfkOlyZyrSDD8ZzWSkXcF3q3OLMaYYGc8SYw&s",
  //   },
  //   {
  //     id: 3,
  //     name: "Huile de Nigelle Premium",
  //     description:
  //       "Anti-inflammatoire puissant – excellente pour le diabète & l’immunité.",
  //     price: 9500,
  //     image:
  //       "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSju8v1p1_krQqji7uh3IWrTQdFjC7FxgZUgA&s",
  //   },
  //   {
  //     id: 4,
  //     name: "Superfood Mix Détox",
  ...
  const guides = [
    {
      ...
      description:
        "Manuel pratique de 50 pages avec recettes, techniques de préparation et plans de menus",
      pages: 50,
      downloadCount: 1247,
      type: "PDF",
    },
    {
      ...
      description:
        "Programme complet de détoxification avec guide jour par jour et recettes de jus",
      pages: 35,
      downloadCount: 890,
      type: "PDF",
    },
    {
      ...
      description:
        "Encyclopédie illustrée de 80 aliments aux propriétés curatives exceptionnelles",
      pages: 75,
      downloadCount: 1456,
      type: "PDF",
    },
  ...
  useEffect(() => {
    fetch("https://lfdsite.onrender.com/products")
      .then(res => res.json())
  ...
  const filteredArticles = articles.filter((article) => {
    ...
    const matchesCategory =
      ...
      (Array.isArray(article.tags) && article.tags.includes(selectedCategory));
            ...
            <div className="featured-article">
              <div className="featured-content">
                ...
                <div className="article-meta">
                  ...
                  <div className="meta-item">
                    ...
                    <span>
                      {new Date(
                        filteredArticles[0].published_date
                      ).toLocaleDateString("fr-FR")}
                    </span>
                  </div>
                  <div className="meta-item">
                    <Clock size={16} />{" "}
                    <span>{filteredArticles[0].read_time} min</span>
                  </div>
                </div>
              ...
              <div className="featured-image">
                <div className="image-placeholder">
                  ...
                  {/* ✅ CORRECTION : Pas de JSON.parse */}
                  {Array.isArray(filteredArticles[0].tags) &&
                ...
                <div className="article-image">
                  ...
                  {Array.isArray(article.tags) &&
                    article.tags.map((tag, idx) => (
                      <div key={idx} className="article-category">
                        {tag}
                      </div>
                    ))}
                </div>
                <div className="article-content">
                  ...
                  <div className="article-footer">
                    <div className="article-meta">
                      ...
                      <span className="read-time">{article.read_time} min</span>
                    </div>
      ...
      <section className="products-section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="body-large">
              Compléments, thés, poudres nutritionnelles & extraits
              thérapeutiques
            </p>
          </div>
      ...
      <section className="guides-section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="body-large">
              Ressources complètes et pratiques pour approfondir vos
              connaissances
            </p>
          </div>
        ...
        <div className="container">
          <div className="newsletter-content">
            <div className="newsletter-text">
              ...
              <p className="body-large">
                Recevez nos derniers articles, conseils santé et guides
            ...
            <div className="newsletter-form">
              ...
              <form className="subscribe-form">
                ...
                <p className="newsletter-disclaimer body-small">
                  Pas de spam, désabonnement en un clic. Vos données restent
                  confidentielles.
                </p>
              </form>
            </div>
